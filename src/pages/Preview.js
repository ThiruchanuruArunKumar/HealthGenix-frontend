function Preview() {
  return (
    <div className="min-h-screen overflow-hidden" 
      style={{background: 'linear-gradient(135deg, #0a0f1e 0%, #0d1b2a 50%, #0a1628 100%)', fontFamily:"'Inter', sans-serif"}}>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] rounded-full opacity-25"
          ...
          animation:'float3 12s ease-in-out infinite'}}></div>
        {/* Subtle grid */}
      ...
      <nav className="relative z-50 flex items-center justify-between px-8 py-5"
        ...
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center font-black text-white text-sm relative"
            style={{background:'linear-gradient(135deg, #14b8a6, #8b5cf6)'}}>
            <span>H</span>
            <div className="absolute inset-0 rounded-xl"
              style={{background:'linear-gradient(135deg, #14b8a6, #8b5cf6)', filter:'blur(8px)', opacity:0.5, zIndex:-1}}></div>
          </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          {['Features', 'How it Works', 'Domains', 'FAQ'].map((item, i) => (
            <span key={i} className="text-gray-400 hover:text-white text-sm cursor-pointer transition-all duration-200 hover:text-teal-400">{item}</span>
          ))}
        </div>
        <div className="flex items-center gap-3">
          <button className="text-gray-400 hover:text-white text-sm px-4 py-2 transition-colors">Sign In</button>
          <button className="text-white text-sm font-bold px-5 py-2.5 rounded-xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden"
      ...
      {/* Hero */}
      <section className="relative z-10 max-w-7xl mx-auto px-8 pt-20 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1 className="slide-up-delay-1 text-6xl font-black leading-none mb-6 tracking-tight text-white">
              Your Health,<br/>
              <span className="shimmer-text">Predicted.</span><br/>
              <span className="shimmer-text">Protected.</span>
            </h1>

            <p className="slide-up-delay-2 text-gray-400 text-lg mb-10 leading-relaxed max-w-xl">
            ...
            <div className="slide-up-delay-3 flex items-center gap-4 mb-12">
              <button className="text-white font-bold px-8 py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 text-lg relative overflow-hidden"
                style={{background:'linear-gradient(135deg, #14b8a6, #3b82f6)', boxShadow:'0 0 30px rgba(20,184,166,0.4)'}}>
                Get Your Health Score →
              </button>
              <button className="glass text-white font-bold px-8 py-4 rounded-2xl transition-all duration-300 hover:bg-white/10 text-lg">
                See Dashboard
              </button>
            </div>

            {/* Stats */}
            <div className="slide-up-delay-4 grid grid-cols-4 gap-3">
              {[
            ...
            <div className="relative rounded-3xl p-6 shadow-2xl"
              ...
              <div className="flex items-center justify-between mb-5">
                ...
                <div className="flex items-center gap-2 glass rounded-full px-3 py-1">
                  <span className="w-1.5 h-1.5 rounded-full" style={{background:'#14b8a6', animation:'pulse 1.5s ease-in-out infinite'}}></span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="glass rounded-2xl p-6 card-glow transition-all duration-300 cursor-default"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={i} className="glass rounded-2xl p-4 text-center card-glow transition-all duration-300 cursor-default">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden p-16 text-center"
            ...
            <div className="relative">
              ...
              <button className="text-gray-900 font-black px-10 py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 text-lg shadow-2xl"
